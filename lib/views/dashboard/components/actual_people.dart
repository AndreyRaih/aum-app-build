...
class _AvatarGroup extends StatelessWidget {
  Widget _getAvatarMiniature(String uri) {
    return Container(
        ...
        decoration: BoxDecoration(color: Color(0xFFEEF7FE), borderRadius: BorderRadius.circular(48)),
  ...
  Widget build(BuildContext context) {
    return Stack(overflow: Overflow.visible, children: <Widget>[
      AumAvatar(uri: 'https://i.pinimg.com/736x/46/a4/2e/46a42ec536aba119386fadacc1b00e73.jpg'),
      Positioned(bottom: -4, right: 0, child: _getAvatarMiniature('https://networthpost.org/wp-content/uploads/2018/02/Roll-Safe-Net-Worth.jpg')),
      Positioned(bottom: -4, right: 4, child: _getAvatarMiniature('https://i.pinimg.com/736x/36/49/f0/3649f0878034f82e578df692587dd452.jpg')),
    ]);
  }
}
