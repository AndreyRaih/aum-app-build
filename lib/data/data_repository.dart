...
class DataRepository {
  ...
  Future<List<AsanaVideoPart>> getAsanaQueue() async {
    return apiClient.getPersonalQueue();
  }

  Future<AumUser> getUserModel() async {
    return apiClient.getUserModel();
  }
}
...
class ApiClient {
  ...
  Future<AumUser> getUserModel() {
    String url = '${baseURL}';
    return http.get(url).then((value) => AumUser());
  }
}
